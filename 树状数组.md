...
不妨设原数组为![](https://latex.codecogs.com/gif.latex?a),树状数组为![](https://latex.codecogs.com/gif.latex?t),则有![](https://latex.codecogs.com/gif.latex?\sum\limits_{i=x-lowbit\left(x\right)+1}^xa_i=t_x)。
