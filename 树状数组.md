...
其实就是一个二进制数最后的 ![](https://latex.codecogs.com/gif.latex?1) 及它后面的若干个 ![](https://latex.codecogs.com/gif.latex?0) 组成的二进制数，有：

![](https://latex.codecogs.com/gif.latex?lowbit(i)=i\&%20-i)

其中 ![](https://latex.codecogs.com/gif.latex?\&) 表示按位与。
